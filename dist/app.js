...
"use strict";
/* harmony import */ var E_PersonalFiles_Coding_payBook_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/regenerator.js */ "./node_modules/@babel/runtime/helpers/esm/regenerator.js");
/* harmony import */ var E_PersonalFiles_Coding_payBook_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ "./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js");
...
function App(props) {
  var _useAuthStore = (0,_store_auth__WEBPACK_IMPORTED_MODULE_3__.useAuthStore)(),
    token = _useAuthStore.token,
    setToken = _useAuthStore.setToken;
  var doLogin = /*#__PURE__*/function () {
    var _ref = (0,E_PersonalFiles_Coding_payBook_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_4__["default"])(/*#__PURE__*/(0,E_PersonalFiles_Coding_payBook_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_5__["default"])().m(function _callee() {
      var res, _t;
      return (0,E_PersonalFiles_Coding_payBook_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_5__["default"])().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 1:
            _context.p = 1;
            _context.n = 2;
            return (0,_services_auth__WEBPACK_IMPORTED_MODULE_2__.loginWithWechatCode)();
          case 2:
            res = _context.v;
          ...
          case 3:
            _context.p = 3;
            _t = _context.v;
            console.error('[Auth] login failed', _t);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    if (true) {
      var getRoute = function getRoute() {
        try {
          ...
          return (last === null || last === void 0 ? void 0 : last.route) || 'unknown';
        } catch (e) {
          console.error('[Weapp] getCurrentPages failed', e);
          return 'unknown';
        }
      };
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().onError(function (msg) {
        console.error('[Weapp] onError', {
          route: getRoute(),
          msg: msg
        });
        _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
      ...
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().onUnhandledRejection(function (res) {
        console.error('[Weapp] onUnhandledRejection', {
          route: getRoute(),
          res: res
        });
      });
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().onPageNotFound(function (res) {
    ...
    if (false) { var onRejection, onError, shouldReload, reloading; }
  }, []);
...
var config = {"pages":["pages/index/index","pages/statistics/index","pages/budgets/index","pages/mine/index","pages/recurringTemplates/index","pages/recurringEdit/index","pages/pendingTransactions/index","pages/exportCsv/index","pages/addTransaction/index","pages/transactions/index","pages/transfer/index","pages/budgetEdit/index"],"window":{"backgroundTextStyle":"light","navigationBarBackgroundColor":"#ffffff","navigationBarTitleText":"轻记","navigationBarTextStyle":"black"},"tabBar":{"color":"#4E5969","selectedColor":"#4A90D9","backgroundColor":"#ffffff","list":[{"pagePath":"pages/index/index","text":"首页"},{"pagePath":"pages/statistics/index","text":"统计"},{"pagePath":"pages/budgets/index","text":"预算"},{"pagePath":"pages/mine/index","text":"我的"}]}};
